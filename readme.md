...
Репозиторий включает в себя не только конфиги hyprland,но и терминала,консольного текстового редактора,syshud,pipewire,quickshell и fastfetch
...
* Аналог ls: `lsd`
* Также есть скрипт по подключению к wifi из консоли,расположенный по пути `config/quickshell/scripts`
